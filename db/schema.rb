...
ActiveRecord::Schema[8.0].define(version: 2024_12_12_123651) do
  ...
  create_table "acr_cloud_recognitions", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["digital_remaster_id"], name: "unique_index_acr_cloud_recognitions_on_digital_remaster_id", unique: true
    t.index ["error_code"], name: "index_acr_cloud_recognitions_on_error_code"
  end
