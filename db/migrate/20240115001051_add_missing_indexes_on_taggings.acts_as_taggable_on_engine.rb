...
class AddMissingIndexesOnTaggings < ActiveRecord::Migration[6.0]
  def change
    ...
    unless index_exists? ActsAsTaggableOn.taggings_table, [:taggable_id, :taggable_type, :tagger_id, :context],
      name: "taggings_idy"
      add_index ActsAsTaggableOn.taggings_table, [:taggable_id, :taggable_type, :tagger_id, :context],
        name: "taggings_idy"
    end
  end
end
