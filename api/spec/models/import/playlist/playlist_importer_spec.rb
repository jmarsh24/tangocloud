...
RSpec.describe Import::Playlist::PlaylistImporter, type: :model do
  ...
  let!(:volver_a_sonar) { create(:recording, composition_title: "Volver a soñar", audio_transfers: [audio_transfer_volver]) }
  ...
  let!(:farol) { create(:recording, composition_title: "Farol", audio_transfers: [audio_transfer_farol]) }
